...
class Montana2(QtWidgets.QWidget):
    ...
    def __init__(self) -> None:
        ...
        ui_path = os.path.join(os.path.dirname(__file__), "montana2.ui")
    ...
    def _on_connect_clicked(self):
        if self.logic.isRunning():
            self._update_status("Montana is busy.")
            return
    ...
    def _on_get_temperature_clicked(self):
        ...
        def get_stability_after_temperature():
            try:
                self.logic.finished.disconnect(get_stability_after_temperature)
            except TypeError:
                pass
        ...
        self.logic.finished.connect(get_stability_after_temperature)
