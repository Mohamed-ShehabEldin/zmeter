...
class ethernet_winspec_logic:
    ...
    # def get_spectrum_avg(self):
        # check if there is a new .spe file in "\\192.168.0.1\trigger\data"
        # transform it to .txt in path determined by the user inside this fucntion
        # i.e out_path="C:\Users\opticool\Documents\Mohamed\20260218_Zhe_Mingyang__d1\data3"
        # compute the average of spectrum from 705 nm to 785 nm
        # return average
